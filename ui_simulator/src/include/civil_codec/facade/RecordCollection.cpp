...
vector<string *> *RecordCollection::makeACopyOfRecordElementNames(unsigned int recordNumber) {
    ...
    std::copy(originalVectorOfElementName->begin(), originalVectorOfElementName->end(),
              copyOfCollectionOfElementName->begin());
...
vector<ElementValue *> *RecordCollection::makeACopyOfRecordElementValues(unsigned int recordNumber) {
    ...
    vector<ElementValue *> *copyOfCollectionOfElementValue = new vector<ElementValue *>(
            originalVectorOfElementValue->size());

    std::copy(originalVectorOfElementValue->begin(), originalVectorOfElementValue->end(),
              copyOfCollectionOfElementValue->begin());
...
void RecordCollection::addRecordsInCollection(RecordCollection *recordsToAdd) {
    ...
    collectionOfRawRecord->insert(collectionOfRawRecord->end(), otherCollectionOfRawRecord->begin(),
                                  otherCollectionOfRawRecord->end());
    ...
    collectionOfRecordCategoryNumber->insert(collectionOfRecordCategoryNumber->end(),
                                             otherCollectionOfRecordCategoryNumber->begin(),
