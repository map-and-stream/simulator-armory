...
public:
     ...
     * @param civil_bytestreamOffset Offset into the bytestream where the failure happened
     ...
     */
    void addFailure(unsigned int categoryNumber, unsigned int civil_bytestreamOffset, string itemName,
...
private:
    ...
    vector<unsigned int> civil_bytestreamOffsets;
