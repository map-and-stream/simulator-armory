...
enum returnCodesEnum {
    ...
    /**
     * An error occurred during the loading of the civil input file.
     */
            AST_LOADER_ERROR = 2,

    /**
     * An error occurred during the loading of the civil configuration Archive or JSON files not found.
     */
            AST_CONFIG_LOADER_ERROR = 3,

    /**
     * Impossible to load the civil Configuration into the library because it is not well-formed.
     */
