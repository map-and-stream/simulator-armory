...
public:
    ...
    unsigned int getInteger16bitBEValuePoolSize();

    unsigned int getInteger32bitBEValuePoolSize();

    unsigned int getInteger64bitBEValuePoolSize();
...
private:
    ...
    /**
     * Map containing the civil Description accessible by a key.
    ...
    unsigned int integer16bitBEValuePoolSize;
    unsigned int integer32bitBEValuePoolSize;
    unsigned int integer64bitBEValuePoolSize;
