...
enum class RepresentationModeEnum {
    ...
    Signed16bitIntegerBEValue = 14,
    Signed32bitIntegerBEValue = 15,
    Signed64bitIntegerBEValue = 16,
    Unsigned16bitIntegerBEValue = 17,
    Unsigned32bitIntegerBEValue = 18,
    Unsigned64bitIntegerBEValue = 19
};
