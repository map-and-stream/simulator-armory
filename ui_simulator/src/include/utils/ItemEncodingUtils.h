...
public:
    ...
    encodeFixedLengthItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
     ...
     */
    static std::vector<unsigned char> *
    encodeExtendedLengthItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                             Item *itemToEncode, unsigned int categoryNumber);
     ...
     */
    static std::vector<unsigned char> *
    encodeRepetitiveLengthItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                               Item *itemToEncode, unsigned int categoryNumber);
     ...
     */
    static std::vector<unsigned char> *
    encodeCompoundLengthItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                             Item *itemToEncodeDescription, std::vector<Item> *compoundSubItemsDescription,
     ...
     */
    static std::vector<unsigned char> *
    encodeREFItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                  Item *itemToEncode,
                  std::vector<Item> *compoundSubItemsDescription, std::vector<Item> *refItemDescription,
                  unsigned int categoryNumber);
     ...
     */
    static std::vector<unsigned char> *
    encodeSPFItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                  Item *itemToEncode,
                  std::vector<Item> *compoundSubItemsDescription, std::vector<Item> *spfItemDescription,
                  unsigned int categoryNumber);
     ...
     */
    static std::vector<unsigned char> *
    encodeExplicitLengthItem(vector<string *> *decodedElementNames, vector<ElementValue *> *decodedElementValues,
                             Item *itemToEncode, std::vector<Item> *compoundSubItemsDescription,
                             std::vector<Item> *refItemDescription,
...
private:
     ...
     */
    static void
    removeDecodedElementNameAndValueFromCollections(unsigned int indexOfElement, vector<string *> *decodedElementNames,
     ...
     */
    static unsigned int
    calculateExtendedItemLength(vector<string *> *decodedElementNames, Item *itemToEncode, unsigned int categoryNumber);
