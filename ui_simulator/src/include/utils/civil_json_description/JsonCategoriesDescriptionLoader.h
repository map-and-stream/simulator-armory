#ifndef UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONLOADER_H_
#define UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONLOADER_H_
...
public:
    /*
     * 1) Load civilConfiguration.json
    ...
    /**
     * Reading the 'civilConfiguration.json' file, it loads the description of each Category.
     * @param civilConfiguration_fpath Full path to 'civilConfiguration.json' file
     ...
     */
    static void loadcivilDescription(string &civilConfiguration_fpath,
     ...
     * @param civilConfiguration_fpath Path where json configuration file is stored
     ...
     */
    static void
    loadUapAndMandatoryItemsList(const string &civilConfiguration_fpath, const string &uapDescription_fpath,
    ...
    static void
    loadItemsDescription(const string &civilConfiguration_fpath, const string &itemsDescription_fpath,
     ...
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
    static void loadReservedExpansionFieldDescription(const string &civilConfiguration_fpath,
     ...
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
    static void loadSpecialPurposeFieldDescription(const string &civilConfiguration_fpath,
     ...
     * @param itemsDescription Reference to an ExternalCategoryDescription instance, holding the civil Category JSON description loaded from a file
     * @param refDescription Reference to an ExternalCategoryDescription instance, holding the civil Category JSON description loaded from a file
     * @param spfDescription Reference to an ExternalCategoryDescription instance, holding the civil Category JSON description loaded from a file
     ...
     * @param extCategoryDescription Pointer to an ExternalCategoryDescription instance, holding the civil Category JSON description loaded from a file
     ...
     * @param serialized_civilConfiguration_fpath File path to the serialized file
     * @param uapMap Pointer to a container of categories description, to be filled with the de-serialized data
     * @param status Pointer to a ReturnStatus instance, where a code status and a message are stored
     */
//    static void getCategoriesDescriptionMapFromSerialization(const string &serialized_civilConfiguration_fpath,
//                                                             unordered_map<int, CategoryDescription *> *uapMap,
//                                                             ReturnStatus *status);
...
#endif /* UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONLOADER_H_ */
