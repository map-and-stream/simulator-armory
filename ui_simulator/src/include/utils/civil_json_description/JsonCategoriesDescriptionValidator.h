#ifndef UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONVALIDATOR_H_
#define UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONVALIDATOR_H_
...
public:
     ...
     * @param uapMap map containing already declared civil Description
     ...
     */
    static int
    splitDatasourceString(string civilConfiguration_fpath, int categoryNumber, string originalDatasource,
                          ReturnStatus *status);
...
#endif /* UTILS_civil_JSON_DESCRIPTION_JSONCATEGORIESDESCRIPTIONVALIDATOR_H_ */
