...
public:
     ...
     */
    static ElementValue *
    toDecimal(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
     ...
     */
    static ElementValue *
    toHexadecimal(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
                  RepresentationModeEnum *representationMode, Range *validRange, unsigned int categoryNumber,
                  string *elementName,
                  DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
    ...
    static ElementValue *toAscii(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
                                 RepresentationModeEnum *representationMode, unsigned int categoryNumber,
                                 string *elementName,
                                 DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
     ...
     */
    static ElementValue *
    CA2toDecimal(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
                 RepresentationModeEnum *representationMode, Range *validRange, unsigned int categoryNumber,
                 string *elementName,
                 DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
     ...
     */
    static ElementValue *
    CA2toHexadecimal(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
                     RepresentationModeEnum *representationMode, Range *validRange, unsigned int categoryNumber,
                     string *elementName,
                     DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
    ...
    static ElementValue *toOctal(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
                                 ...
                                 unsigned int categoryNumber, string *elementName,
                                 DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
     ...
     */
    static ElementValue *
    toTargetId(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
     ...
     */
    static ElementValue *
    toMBData(unsigned char *hexValue, int *elementLengthInBit, double *multiplicationFactorToDecode,
             RepresentationModeEnum *representationMode, unsigned int categoryNumber, string *elementName,
             DecodedValueObjectPoolManager *decodedValueObjectPoolManager);
