...
public:
    ...
    static RepresentationModeEnum getRepresentationModeEnumFromString(string representationModeEnumInString) {
        ...
        } else if (representationModeEnumInString == "UnsignedInteger16bitBEValue") {
            return RepresentationModeEnum::Unsigned16bitIntegerBEValue;

        } else if (representationModeEnumInString == "UnsignedInteger32bitBEValue") {
            return RepresentationModeEnum::Unsigned32bitIntegerBEValue;

        } else if (representationModeEnumInString == "UnsignedInteger64bitBEValue") {
            return RepresentationModeEnum::Unsigned64bitIntegerBEValue;
        ...
        } else if (representationModeEnumInString == "SignedInteger16bitBEValue") {
            return RepresentationModeEnum::Signed16bitIntegerBEValue;

        } else if (representationModeEnumInString == "SignedInteger32bitBEValue") {
            return RepresentationModeEnum::Signed32bitIntegerBEValue;

        } else if (representationModeEnumInString == "SignedInteger64bitBEValue") {
            return RepresentationModeEnum::Signed64bitIntegerBEValue;
