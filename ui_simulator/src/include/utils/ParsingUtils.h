...
public:
    ...
    /**
     * It parses an entire Datablock of civil.
     * @param civil_datablock Pointer to the civil bytestream
     * @param categoriesDescription Pointer to the description of civil already loaded in memory
     ...
     * @param bufferIndex Position of the datablock into the civil bytestream
     * @return Number of records read
     */
    static unsigned long long
    parseDatablock(unsigned char *civil_datablock, unsigned short int datablockCategory, int datablockLength,
                   unordered_map<int, CategoryDescription *> *categoriesDescription, int bufferIndex);

    /**
     * It parses all records into a Datablock of civil.
     * @param civil_datablock Pointer to the civil bytestream
     * @param bufferIndex Position of the datablock into the civil bytestream
     * @param datablockCategory Category number of the datablock to be parsed
     * @param datablockLength Length in byte of the datablock to be parsed
     * @param categoriesDescription Pointer to the description of civil already loaded in memory
     * @param threadId Thread id where the function is running
     * @return Number of records read
     */
    static int
    parseAllRecords(unsigned char *civil_datablock, int bufferIndex, int datablockCategory, int datablockLength,
                    unordered_map<int, CategoryDescription *> *categoriesDescription, pthread_t threadId);

    /**
     * It parses an element, the smallest part of an civil message saving the result in the 'octets' parameter.
     ...
     * @param civil_datablock Pointer to the input civil bytestream to be parsed
     ...
     */
    static int readFspec(unsigned char *civil_datablock, int bufferIndex, std::vector<int> *FRN_list);
     ...
     */
    static int parseFirstTwoBytes(unsigned char *civil_datablock, int index);
     ...
     */
    static int
    parseFixedLengthItem(unsigned char *civil_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                         ParsedRecord *objectPool, bool varlen = false);
     ...
     * @param civil_datablock Pointer to the beginning of the current civil datablock
     ...
     */
    static int
    parseExtendedLengthItem(unsigned char *civil_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
     ...
     */
    static int
    parseRepetitiveLengthItem(unsigned char *civil_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                              ParsedRecord *objectPool);
     ...
     */
    static int
    parseCompoundLengthItem(unsigned char *civil_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                            std::vector<Item> *compoundSubItemsDescription, unsigned int categoryNumber,
                            ParsedRecord *objectPool);
     ...
     */
    static int
    parseExplicitLengthItem(unsigned char *civil_datablock, Item *itemToParse, int index, bool isItemToBeDecoded,
                            std::vector<Item> *refItemDescription, std::vector<Item> *subItemsDescription,
                            std::vector<Item> *spfItemDescription,
     ...
     */
    static int calculateExtendedItemLength(unsigned char *civil_datablock, int index, int primarySubfieldLength);
