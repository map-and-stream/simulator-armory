...
public:
    ...
    encodeDecimal(ElementValue *element, Range *validityRange, int lengthInBit, double multFactor, string *elementName,
                  unsigned int categoryNumber);

    static unsigned char *
    encodeDecimalToCA2(ElementValue *element, Range *validityRange, int lengthInBit, double multFactor,
                       string *elementName,
                       unsigned int categoryNumber);
...
private:
     ...
     */
    static void
    checkValidityRange(string *elementName, double elementValue, Range *elementRange, unsigned int categoryNumber);
