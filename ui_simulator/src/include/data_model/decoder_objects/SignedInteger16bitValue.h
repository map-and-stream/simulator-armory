...
public:
    ...
    SignedInteger16bitValue(DecodedValueObjectPoolManager *_ptrToManager, int16_t _decodedValue,
    ...
    void setDecodedValue(int16_t _decodedValue,
                         RepresentationModeEnum _representationMode = RepresentationModeEnum::Signed16bitIntegerValue);
