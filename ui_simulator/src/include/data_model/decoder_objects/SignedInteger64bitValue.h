...
public:
    ...
    SignedInteger64bitValue(DecodedValueObjectPoolManager *_ptrToManager, int64_t _decodedValue,
    ...
    void setDecodedValue(int64_t _decodedValue,
                         RepresentationModeEnum _representationMode = RepresentationModeEnum::Signed64bitIntegerValue);
