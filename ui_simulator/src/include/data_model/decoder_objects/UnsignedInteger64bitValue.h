...
public:
    ...
    UnsignedInteger64bitValue(DecodedValueObjectPoolManager *_ptrToManager, uint64_t _decodedValue,
    ...
    void setDecodedValue(uint64_t _decodedValue,
                         RepresentationModeEnum _representationMode = RepresentationModeEnum::Unsigned64bitIntegerValue);
