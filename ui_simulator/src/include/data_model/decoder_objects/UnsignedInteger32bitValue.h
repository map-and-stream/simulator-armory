...
public:
    ...
    UnsignedInteger32bitValue(DecodedValueObjectPoolManager *_ptrToManager, uint32_t _decodedValue,
    ...
    void setDecodedValue(uint32_t _decodedValue,
                         RepresentationModeEnum _representationMode = RepresentationModeEnum::Unsigned32bitIntegerValue);
