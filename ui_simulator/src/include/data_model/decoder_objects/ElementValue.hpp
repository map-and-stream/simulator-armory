 ...
 * There is one child for each 'representationModeForDecoding' value in the 'civilConfiguration' JSON file.
 */
class ElementValue {
public:
    ...
    virtual string getDecodedDataInString() const = 0;

    virtual string *getPointerToDecodedDataInString() = 0;
