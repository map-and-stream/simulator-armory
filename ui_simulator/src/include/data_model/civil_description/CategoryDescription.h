...
/**
 * \brief This class represents the civil Category JSON description in the internal Codec data model.
...
public:
    ...
    CategoryDescription(vector<Item> _itemsDescription, vector<Item> _compoundSubItemsDescription,
                        vector<Item> _refItemDescription,
    ...
    /**
     * Returns a pointer to the vector of Item instances, describing an civil Category.
     * @return a vector<Item>* holding the Item collection of an civil Category
     */
    vector<Item> *getItemCollection();

    /**
     * Sets a vector of Item instances, representing the Item collection of an civil Category JSON description.
    ...
    /**
     * Returns a pointer to the vector of Item instances, describing an civil Category.
     * @return a vector<Item>* holding the collection of Compound Subitems of an civil Category
     */
    vector<Item> *getCompoundSubItemsDescription();

    /**
     * Sets a vector of Item instances, representing the Compound Subitem collection of an civil Category JSON description.
    ...
    /**
     * Returns a pointer to the vector of Item instances, describing an civil Category.
     * @return a vector<Item>* holding the Reserved Expansion Field (REF) Item collection of an civil Category
     */
    vector<Item> *getRefItemDescription();

    /**
     * Sets a vector of Item instances, representing the Reserved Expansion Field (REF) Item collection of an civil Category JSON description.
    ...
    /**
     * Returns a pointer to the vector of Item instances, where the civil Category JSON description is mapped to.
     * @return a vector<Item>* holding the Item collection of the Special Purpose Field (SPF) of an civil Category
     */
    vector<Item> *getSpfItemDescription();

    /**
     * Sets a vector of Item instances, representing the Special Purpose Field (SPF) Item collection of an civil Category JSON description.
