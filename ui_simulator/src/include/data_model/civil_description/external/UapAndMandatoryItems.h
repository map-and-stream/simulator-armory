#ifndef DATA_MODEL_civil_DESCRIPTION_EXTERNAL_UAPANDMANDATORYITEMS_H_
#define DATA_MODEL_civil_DESCRIPTION_EXTERNAL_UAPANDMANDATORYITEMS_H_
...
#endif /* DATA_MODEL_civil_DESCRIPTION_EXTERNAL_UAPANDMANDATORYITEMS_H_ */
