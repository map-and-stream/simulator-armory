...
/**
 * \brief This class collects all reference to the files a given Edition of an civil Category description is made of.
 *
 */
...
private:
    /**
     * Value coming from the civil configuration file to generate the map civil Description.
     * civil Edition number a.k.a edition name
     */
