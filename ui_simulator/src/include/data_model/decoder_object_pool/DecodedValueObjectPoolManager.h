...
public:
     ...
     * @return SignedInteger16bitValue pointer to use
     */
    SignedInteger16bitBEValue *getSignedInteger16bitBEValueFromOP();
     ...
     * @return SignedInteger32bitValue pointer to use
     */
    SignedInteger32bitBEValue *getSignedInteger32bitBEValueFromOP();
     ...
     * @return IntegerValue object to use
     */
    SignedInteger64bitBEValue *getSignedInteger64bitBEValueFromOP();
     ...
     * @return UnsignedInteger16bitValue pointer to use
     */
    UnsignedInteger16bitBEValue *getUnsignedInteger16bitBEValueFromOP();
     ...
     * @return UnsignedInteger32bitValue pointer to use
     */
    UnsignedInteger32bitBEValue *getUnsignedInteger32bitBEValueFromOP();
     ...
     * @return IntegerValue object to use
     */
    UnsignedInteger64bitBEValue *getUnsignedInteger64bitBEValueFromOP();
...
private:
    ...
    ObjectPool<SignedInteger16bitBEValue> *signedInteger16bitBEValueObjectPool;
    ObjectPool<SignedInteger32bitValue> *signedInteger32bitValueObjectPool;
    ObjectPool<SignedInteger32bitBEValue> *signedInteger32bitBEValueObjectPool;
    ObjectPool<SignedInteger64bitValue> *signedInteger64bitValueObjectPool;
    ObjectPool<SignedInteger64bitBEValue> *signedInteger64bitBEValueObjectPool;
    ...
    ObjectPool<UnsignedInteger16bitBEValue> *unsignedInteger16bitBEValueObjectPool;
    ObjectPool<UnsignedInteger32bitValue> *unsignedInteger32bitValueObjectPool;
    ObjectPool<UnsignedInteger32bitBEValue> *unsignedInteger32bitBEValueObjectPool;
    ObjectPool<UnsignedInteger64bitValue> *unsignedInteger64bitValueObjectPool;
    ObjectPool<UnsignedInteger64bitBEValue> *unsignedInteger64bitBEValueObjectPool;
